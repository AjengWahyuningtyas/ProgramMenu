...
class SignupActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(id.ajeng.recycleviewnew.R.layout.activity_signup)
        ...
        _loginLink!!.setOnClickListener {
            ...
            finish()
            overridePendingTransition(id.ajeng.recycleviewnew.R.anim.push_left_in, id.ajeng.recycleviewnew.R.anim.push_left_out)
        }
    }
